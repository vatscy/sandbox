...
var config = {
  apiKey: "AIzaSyA8W_xE1trG5MQ-cLEVjCTq1YpqtJ2sdis",
  authDomain: "sakutto-chat-bfbc9.firebaseapp.com",
  databaseURL: "https://sakutto-chat-bfbc9.firebaseio.com",
  storageBucket: "sakutto-chat-bfbc9.appspot.com",
  messagingSenderId: "165629459402"
};
...
export function login() {
  ...
  if(typeof cordova==="undefined"){
    ...
    ref = window.open('https://sakutto-chat-bfbc9.firebaseapp.com/login.html?t=' + new Date().getTime(), '_blank', 'location=yes');
